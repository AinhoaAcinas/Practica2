...
gberror2 <- ggplot(Experimento, aes(x = Dosis, y = Altura)) + geom_errorbar(aes(ymin=Altura-Error_Altura, ymax=Altura+Error_Altura), width =.1, position = position_dodge(0.05)) + geom_point(aes(shape = Complemento))+ geom_line(aes(linetype = Complemento), colour = "Red") + theme_classic()
gberror2
